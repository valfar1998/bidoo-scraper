...
PROFILES: dict[str, SiteProfile] = {
    ...
    "ebay_source": SiteProfile(
        ...
        default_outbound_vinted=6.0,
        default_outbound_subito=8.0,
        needs="Opzionale EBAY_APP_ID. Senza chiave usa ricerca HTML aste in chiusura.",
        notes="Cerca aste in chiusura (HTML senza chiave, o Finding API se EBAY_APP_ID).",
        telegram_color_note="eBay · aste in chiusura",
        listing_kind="auction",
    ),
